...
function SidebarNavigation({ tripId }: SidebarNavigationProps) {
  return (
    <div className="sidebar-stack">
      <div className="sidebar-brand"><div className="sidebar-brand__name">Travel Planner</div><div className="sidebar-brand__caption">Personal travel workspace</div></div>
      <NavLink to="/trips" className={activeClass}><HomeIcon /><span>Trips</span></NavLink>
      {tripId ? <>
        <NavLink to={`/trip/${tripId}/itinerary`} className={activeClass}><CalendarIcon /><span>Itinerary</span></NavLink>
